/*******************************************
  ...
  Author: Arjun Menon  |  Date: 21/10/05
*******************************************/
...
void iftopf(const char *str, char *err, char *pfe)
{
	...
	// commas(','). If an error has occured during
	// the translation, then a string describing the
	// error & starting with a '#' is stored in *pfe.
