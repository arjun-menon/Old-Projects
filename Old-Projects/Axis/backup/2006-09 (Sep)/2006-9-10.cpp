/***************************************************
   ...
   |    Release Date: 2006 September 10          |
****************************************************/
...
void strnum(char *str, const unsigned int num, const unsigned int len);
...
uchar debug_mode = 0;
#elif AI_DEBUG == 0x2
const uchar debug_mode = 1;
#elif AI_DEBUG == 0x3
const uchar debug_mode = 0;
#else
...
void string(char *str)
{
	// remove a new-line char from strings if present.
