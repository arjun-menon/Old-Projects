/***************************************************
   ...
   |    Release Date: 2006 September 20          |
****************************************************/
...
num32 store_str(char *str, LIST str_array, num32 array_size)
{
	array_size++;
...
const char * fetch_str(num32 index, LIST str_array, num32 array_size)
{
	if(index <= array_size)
