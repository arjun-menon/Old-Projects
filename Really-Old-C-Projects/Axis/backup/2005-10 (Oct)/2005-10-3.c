/*******************************************
  ...
  Author: Arjun Menon  |  Date: 3/10/05
*******************************************/
...
void exec(const char *str, char *err)
{
	...
	void * eval(const char *str, const char data_type);
	...
	char data_type = '\0'; /* data type of variableto evaluate */
