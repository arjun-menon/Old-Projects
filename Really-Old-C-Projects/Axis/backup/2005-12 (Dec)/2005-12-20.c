/***************************************************
  ...
  Author  Name: Arjun G. Menon  |  Date: 20/12/2005
****************************************************/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
void sval_int32(const char *str, int32 * const value);
int32 * xval_int32(const char *str, int32 *value);
num32 lex_cmd(const char *str, char ** cmd);
/* memory management: */
...
int32 * xval_int32(const char *str, int32 *value)
{
	 ...
	 *  into *err & a NULL pointer is returned.
	 */
	// <-------------- NOT COMPLETED ------------------>
