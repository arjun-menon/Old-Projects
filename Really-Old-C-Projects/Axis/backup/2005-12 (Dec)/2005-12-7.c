/***************************************************
  ...
  Author  Name: Arjun G. Menon  |  Date: 7/12/2005
****************************************************/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int32 * new_int32(struct int32_list * int32_offset, const num32 id_num);
int32 * get_int32(struct int32_list * int32_offset, const num32 id_num);
num32 del_int32(struct int32_list * int32_offset, const num32 id_num);
...
inline void init_int32(struct int32_list ** int32_offset)
{
	if((*int32_offset = (struct int32_list*) malloc
	(sizeof(struct int32_list)))==NULL) msg("bla",3);
...
num32 del_int32(struct int32_list * int32_offset, const num32 id_num)
{
	/* returns the array size of the variable freed. */
	return 0;
}
