/***************************************************
  ...
  Author  Name: Arjun G. Menon  |  Date: 8/12/2005
****************************************************/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
struct struct_num32_hash_table
{
	char *ids;  /* hash string */
	num32 key;  /* hash value */
};
static struct struct_num32_hash_table * universal_hash_table = NULL;
static num32 universal_hash_table_size = 0;
...
char del_int32(struct int32_list * int32_offset, const num32 id_num)
{
	/* delete a variable an int32 list.
