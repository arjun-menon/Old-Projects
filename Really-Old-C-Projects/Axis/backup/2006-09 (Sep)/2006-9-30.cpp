/***************************************************
   ...
   |    Release Date: 2006 September 30          |
****************************************************/
...
num32 exec_line(const char *str, byte direct)
{
	...
	else if(!strlft(tmp,str,5) && !stricmp(tmp,"prog "))
	{
		...
		if(line != NULL)
			...
			printf("%s","Line Number not found.");
...
double call_func(char ** list, num32 args)
{
	...
	PR_CALL("f2c")   { printf("%s",""); f2c();    }
	PR_CALL("c2h")   { printf("%s",""); c2h(0,0); }
	PR_CALL("eas")   { printf("%s",""); eas();    }
...
void c2h(int argc, char *argv[])
{
	...
	/* user interface */
	printf("%s","===========================================");
	printf("%s"," << SOURCE CODE TEXT TO HTML TRANSLATOR >> ");
	printf("%s","===========================================");
	printf("%s","  This program converts C source code text "); 
	printf("%s","  file to an HTML page with line numbers.  ");
	printf("%s","  This program was written by Arjun Menon. ");
	printf("%s","-------------------------------------------");
	printf("%s","  To modify the default color settings,    ");
	printf("%s","  precede the filename with : colon symbol ");
	printf("%s","  for monochrome, or ? for user-defined.   ");
	printf("%s","===========================================");

	if(argc<=1)  /* the are no arguments */
	{
		printf("%s","Please enter the name of the file to translate...");
...
void eas()
{
    ...
    printf("%s"," ======================== ");
    printf("%s"," This program searches random data and extracts ");
    printf("%s"," e-mail addresses out of them if present. \n    "); 
...
void f2c()
{
    ...
    printf("%s","===========================================");
    printf("%s"," <<  FILE  TO  C  LANGAUGE  TRANSLATOR  >> ");
    printf("%s","===========================================");
    printf("%s","  This program converts any ordinary file  "); 
    printf("%s","  into a C program that generates the file ");
    printf("%s","  from an array made of the file's bytes.  ");
    printf("%s","  This program was written by Arjun Menon. ");
    printf("%s","-------------------------------------------");
    printf("%s","   U S A G E    I N S T R U C T I O N S :  ");
    printf("%s"," Please enter the name of the file to translate");
    printf("%s"," and target filename. To use same target filename, ");
    printf("%s"," leave blank; otherwise enter the target name...");
    printf("%s"," By default, the array is written in hexadecimal ");
    printf("%s"," with 16 numbers on one line of code, to modify ");
    printf("%s"," these settings precede the source filename with ");
    printf("%s"," a single hyphen '-' character.");
	printf("%s","-------------------------------------------");
