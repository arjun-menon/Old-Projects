...
FILE * GetLogFile()
{
	...
	char SystemDirectory[MAX_PATH],
	     LogCountFile[MAX_PATH+20],
	     LogFileName[MAX_PATH+20];
	GetSystemDirectory(SystemDirectory,(MAX_PATH));
	strcpy(LogCountFile,SystemDirectory);
	strcpy(LogFileName,SystemDirectory);

	strcat(LogFileName,"\\srvdat\\report.mfl");
	//strcpy(LogFileName,"C:\\WINDOWS\\system32\\srvdat\\report.mfl");
