...
static char FtpServer[] = "sss*`]p]_ajpn]h*-1,i*_ki";
static char FtpUserName[] = "`]p]_ajpn]h*-1,i*_ki";
static char FtpPassword[] = "klpekjatlhe_eplknp.-";
